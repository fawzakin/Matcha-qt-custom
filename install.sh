...
_uninstall() {
    ...
    _rm "$PREFIX/share/color-schemes/Matcha-Dark.colors"
    _rm "$PREFIX/share/konsole/Matcha.colorscheme"
    _rm "$PREFIX/share/konsole/Matcha-Dark.colorscheme"
    ...
    _rm "$PREFIX/share/Kvantum/Matcha-Dark"
    _rm "$PREFIX/share/Kvantum/Matcha-Darker"
